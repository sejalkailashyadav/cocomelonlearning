...
//currect working showChildReportsByMonth ficmntion right now 
...
// showChildReportsByMonth it sowkimng 1/9/2025 cuurectly 
...
public function exportCSV(Request $request)
{
    ...
    foreach ($children as $report) {
        ...
        if ($user->user_type === 'Admin') {
            ...
            $baseRow[] = number_format($report->transit_number, 2);
            $baseRow[] = number_format($report->account_number, 2);
        }
