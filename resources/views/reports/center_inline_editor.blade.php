                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                 ...
                                 <td>
                                    <input type="text" step="0.01" name="reports[{{ $report->id }}][institution_number]" value="{{ $report->institution_number ?? 0 }}" class="form-control">
                                </td>
                                 <td>
                                    <input type="number" step="0.01" name="reports[{{ $report->id }}][transit_number]" value="{{ $report->transit_number ?? 0 }}" class="form-control">
                                </td>
                                 <td>
                                    <input type="number" step="0.01" name="reports[{{ $report->id }}][account_number]" value="{{ $report->account_number ?? 0 }}" class="form-control">
                                </td>
